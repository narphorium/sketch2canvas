...
1. Do not use [Value goes here] or [Variable goes here] or any other placeholder text in your instructions. Instead, use the variable names you defined in the <Inputs> tags.
